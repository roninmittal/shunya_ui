      ...
      <div id="wrapper">
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          <div className="content">
            <Navbar collapseOnSelect className="mb-4 bg-primary shadow topbar">
              <Navbar.Toggle aria-controls="responsive-navbar-nav" />
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto text-white h5 pl-3">
                    Admin Dashboard
                </Nav>
                <Nav className="ml-auto">
                  ...
                  <NavDropdown title={
                      <div>
                        <span className="mr-2 d-none d-lg-inline text-white small">Ronin</span>
            ...
            <Container fluid={true}>
                          ...
                          <Card.Body>
                            <Row noGutters={true} className="align-items-center">
                              <Col className="mr-2">
                                ...
                                <div className="mb-0 d-flex">
                                  <div className="d-flex align-items-baseline mb-0 mr-2 h5 font-weight-normal text-gray-800">{this.state.trainedAvgTime} <span className="text-xs font-weight-normal ml-1">Sec Trained</span></div>
                                  <div className="d-flex align-items-baseline font-weight-normal text-gray-800">|</div>
                                  <div className="d-flex align-items-baseline mb-0 ml-2 h5 font-weight-normal text-gray-800">{this.state.predictedAvgTime} <span className="text-xs font-weight-normal ml-1">Sec Predict</span></div>
                                </div>
                              </Col>
                              <Col xs={"auto"}>
              ...
              <Row>
                <Col className="mb-4">
                  <Card className="shadow table-model">
